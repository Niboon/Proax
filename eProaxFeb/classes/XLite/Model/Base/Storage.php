...
abstract class Storage extends \XLite\Model\AEntity
{
    ...
    {
        // Niboon: Replaced encoded slashes with regular slashes for image path
//        return rawurlencode(str_replace(LC_DS, '/', $path));
        return str_replace('%2F', '/',rawurlencode(str_replace(LC_DS, '/', $path)));
    }
